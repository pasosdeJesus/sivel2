# Llamado público a auditar SIVeL 2.2
...
violaciones a los Derechos Humanos con SIVeL  2.2, l@ invitamos a
...
l@ invitamos a buscar fallas de seguridad en SIVeL 2.2, bien
...
[README.md](https://github.com/pasosdeJesus/sivel2/blob/v2.2/README.md) )
...
* La falla debe ser replicable en la instalación de prueba.
  ...
  recomendada (distribución [adJ](https://aprendiendo.pasosdeJesus.org) 7.7
  de OpenBSD, servidor web nginx con SSL,
  PostgreSQL con autenticación y Ruby on Rails 7.2)
...
* Su reporte debe incluir la metodología que empleó para encontrarla 
  y proponer una solución para las fuentes de la rama `v2.2`
  disponibles en el repositorio git 
  https://github.com/pasosdeJesus/sivel2/tree/v2.2
...
* Reporte la falla y suministre la solución como se indica en 
  <https://github.com/pasosdeJesus/sivel2/blob/v2.2/SECURITY.md>
* Su aporte será evaluado y respondido y  en caso de que podamos
  ...
  a una billetera de CELO, Avalanche o Toncoin.

Agradecemos su interés en esta convocatoria pública, cuya versión
más reciente está disponible en
<https://github.com/pasosdeJesus/sivel2/blob/v2.2/doc/Llamado.md>
