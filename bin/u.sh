...
$DOAS su - ${USUARIO_AP} -c "cd $DIRAP; 
  ...
  ${defuroot} BD_CLAVE='${BD_CLAVE}' \
    ...
    SIP_LETRA_FEMENINO=\"${SIP_LETRA_FEMENINO}\" \
    SIP_LETRA_MASCULINO=\"${SIP_LETRA_MASCULINO}\" \
    SIP_LETRA_SININFO=\"${SIP_LETRA_SININFO}\" \
    SIP_NOMBRE_FEMENINO=\"${SIP_NOMBRE_FEMENINO}\" \
    SIP_NOMBRE_MASCULINO=\"${SIP_NOMBRE_MASCULINO}\" \
    SIP_NOMBRE_SININFO=\"${SIP_NOMBRE_SININFO}\" \
