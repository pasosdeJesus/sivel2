...
module Sivel2Gen
  class ControlAccesoCasoFotrasControllerTest < ActionDispatch::IntegrationTest
    ...
    #####################################
    test "Operador sin grupo puede crear otras fuentes de prensa" do
    ...
    test "Operador sin grupo puede eliminar otra fuente de prensa" do
      current_usuario = ::Usuario.find(PRUEBA_USUARIO_OP)
      sign_in current_usuario
      @casoofp = Sivel2Gen::Caso.create(PRUEBA_CASO)
      assert @casoofp.valid?
    ...
    #######################################################
    test "Analista puede crear otras fuentes de prensa" do
    ...
    test "Analista puede eliminar otra fuente de prensa" do
      current_usuario = ::Usuario.find(PRUEBA_USUARIO_AN)
      sign_in current_usuario
      @casoofp = Sivel2Gen::Caso.create(PRUEBA_CASO)
      assert @casoofp.valid?
